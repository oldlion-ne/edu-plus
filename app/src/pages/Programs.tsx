...
export default function Programs() {
 ...
 <Button asChild variant="outline" size="md" className="font-sans rounded-none border-border hover:border-primary transition-colors duration-200">
 <Link to="/lms">Open in LMS</Link>
 </Button>
 </motion.div>
 </MagicCard>
 </motion.div>

...
export default function ImmersiveHero({
  ...
  return (
    <div 
      ref={containerRef}
      className="relative w-full overflow-hidden bg-background border-b border-border/50 select-none group flex flex-col justify-center pt-12 pb-16 md:pb-24 min-h-[75vh]"
    >

...
function Card({
  ...
  size?: "default" | "sm"
  variant?: "default" | "base" | "raised" | "sunken" | "outline"
}) {
  return (
    <div
      data-slot="card"
      ...
      className={cn(
        "group/card flex flex-col gap-4 overflow-hidden rounded-none bg-card py-4 text-sm text-card-foreground has-[>img:first-child]:pt-0 data-[size=sm]:gap-3 data-[size=sm]:py-3",
        (variant === "default" || variant === "base") && "surface-base",
...
function CardEyebrow({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("eyebrow px-4 group-data-[size=sm]/card:px-3", className)}
      {...props}
    />
  )
}
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex items-center px-4 group-data-[size=sm]/card:px-3 [.border-t]:pt-4 group-data-[size=sm]/card:[.border-t]:pt-3",
        className
      )}
      {...props}
    />

...
function AlertDialogMedia({
  ...
  return (
    <div
      ...
      className={cn(
        "mb-2 inline-flex size-8 items-center justify-center rounded-none bg-muted sm:group-data-[size=default]/alert-dialog-content:row-span-2 *:[svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    />

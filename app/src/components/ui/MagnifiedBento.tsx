...
const TAG_ROWS = [
  [
    { id: "skill-assessment", icon: Search01Icon, label: "Skill Assessment" },
    { id: "cohort-learning", icon: UserGroupIcon, label: "Cohort Learning" },
    { id: "curriculum-paths", icon: HierarchyIcon, label: "Curriculum Paths" },
    { id: "industry-mentorship", icon: UserIcon, label: "Industry Mentorship" },
    { id: "continuous-learning", icon: RotateLeftIcon, label: "Continuous Learning" },
  ],
  [
    { id: "interactive-labs", icon: Settings02Icon, label: "Interactive Labs" },
    { id: "ai-tutors", icon: CpuIcon, label: "AI Tutors" },
    { id: "project-portfolios", icon: CodeIcon, label: "Project Portfolios" },
    { id: "progress-tracking", icon: Chart01Icon, label: "Progress Tracking" },
    { id: "micro-learning", icon: FlashIcon, label: "Micro-Learning" },
  ],
  [
    { id: "global-networking", icon: Link01Icon, label: "Global Networking" },
    { id: "mobile-access", icon: SmartPhone01Icon, label: "Mobile Access" },
    { id: "cloud-workspaces", icon: CloudIcon, label: "Cloud Workspaces" },
    { id: "workforce-analytics", icon: DatabaseIcon, label: "Workforce Analytics" },
    { id: "verified-certification", icon: LockIcon, label: "Verified Certification" },
  ],
];

const CONFIG = {
  containerHeight: "h-[300px] sm:h-[400px] lg:h-[480px]",
  lensSize: 92,
};

export const MagnifiedBento = () => {
  ...
  return (
    <div className="flex items-center justify-center w-full not-prose">
      <div className="group relative w-full max-w-[500px] overflow-hidden rounded-none border border-border/50 bg-card p-1.5 sm:p-2 shadow-2xl shadow-primary/5 transition-all duration-500 hover:shadow-primary/10">
        <div
          ref={containerRef}
          className={cn(

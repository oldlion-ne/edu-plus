  ...
  return (
    <section className="mb-20 border-y border-border py-12">
      <div className="mb-8 max-w-2xl">
        <span className="font-sans text-xs uppercase tracking-[0.25em] text-primary">Live calendar</span>
          ...
          <Card key={event.id} className="flex flex-col justify-between border border-border bg-card/40 p-6">
            <div>
              <div className="mb-4 flex items-center justify-between gap-3">
                ...
                {event.capacity !== null && <span className="font-sans text-xs text-muted-foreground">Capacity {event.capacity}</span>}
              </div>
              ...
              <div className="mt-5 space-y-2 border-t border-border pt-4 font-sans text-xs text-muted-foreground">

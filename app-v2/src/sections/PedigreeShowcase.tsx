          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              ...
              >
                <div className="relative flex h-10 items-center gap-12 px-6">
                  ...
                  <div className="bg-card shadow-black/10 ring-border relative flex h-9 items-center rounded-full px-3.5 shadow-md ring transition-transform duration-200 group-hover:scale-105">
            ...
            >
              ...
              >
                ...
                />
                {/* Center dot */}
                <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 size-2 rounded-full bg-primary shadow-[0_0_8px_2px_oklch(var(--primary)/0.4)] transition-all duration-300 group-hover:shadow-[0_0_14px_4px_oklch(var(--primary)/0.5)]" />
              </div>
            </Card>

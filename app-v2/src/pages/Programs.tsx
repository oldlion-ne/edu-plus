  ...
  return (
    <div className="relative h-full w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center select-none pointer-events-none">
        <div className="size-36 rounded-full border border-primary/25 animate-ping opacity-60"></div>
        <div className="size-28 rounded-full border border-dashed border-primary/20"></div>
        <div className="size-20 rounded-full border border-border/40"></div>
      </div>
      {/* Sweeper arm */}
      <div className="absolute size-44 rounded-full border border-primary/10 overflow-hidden">
        <div className="absolute top-1/2 left-1/2 w-full h-full bg-gradient-to-tr from-primary/10 to-transparent origin-top-left animate-[spin_4s_linear_infinite]" style={{ transformOrigin: '0 0' }}></div>
      </div>
  ...
  return (
    <div className="relative h-full w-full flex flex-col justify-center items-center gap-1.5 overflow-hidden px-8">
      <div className="flex w-full justify-between items-center gap-3 relative">
        ...
        <div className="bg-background shadow-xs border border-border rounded-md px-2.5 py-1.5 flex items-center gap-1.5 select-none hover:border-primary/50 transition-colors">
      ...
      <div className="flex w-full justify-center items-center select-none z-10">
        <div className="bg-primary/5 border border-primary/20 rounded-md px-4 py-2 text-[9px] font-mono text-primary font-bold tracking-wider shadow-sm">
...
const MentorshipIllustration = () => {
  return (
    <div className="relative h-full w-full flex flex-col justify-between p-5 overflow-hidden">
      ...
      <div className="absolute w-1 h-1 rounded-full bg-primary/70 animate-[ping_2s_infinite] top-[28%] left-[30%]"></div>
      <div className="absolute w-1 h-1 rounded-full bg-primary/70 animate-[ping_2s_infinite] top-[72%] right-[30%]"></div>

      <div className="relative flex justify-between items-center z-10">
        <div className="bg-background/90 backdrop-blur-xs border border-border rounded-full px-2 py-0.5 text-[8px] font-mono text-muted-foreground flex items-center gap-1 hover:border-primary/50 transition-all select-none">
      ...
      <div className="relative flex justify-center z-10">
        <div className="bg-card shadow-sm border border-primary/20 relative flex h-7 items-center rounded-full px-3 select-none">
...
const PrepIllustration = () => {
  return (
    <div className="relative h-full w-full flex items-center justify-between px-6 overflow-hidden">
      {/* Central Node */}
      <div className="bg-background/90 border border-border p-2 rounded-md z-10 select-none shadow-xs flex flex-col items-center max-w-[120px]">
      ...
      <div className="flex flex-col gap-6 z-10">
        <div className="bg-background/90 border border-border px-2.5 py-1 rounded-md select-none shadow-xs flex items-center gap-1 hover:border-primary/50 transition-colors">
  ...
  return (
    <div className="relative h-full w-full flex justify-between items-end px-5 py-6 overflow-hidden">
      ...
      {Array.from({ length: 15 }).map((_, i) => {
        ...
        return (
          <div key={i} className="flex flex-col items-center gap-1 h-full w-px bg-foreground/10 relative" style={{ height: '100%' }}>
            {isHighlighted && (
              <>
                <div className="absolute inset-0 bg-primary/60 w-0.5 shadow-[0_0_8px_oklch(var(--primary))] animate-pulse"></div>
                <div className="absolute -top-3 w-1 h-1 rounded-full bg-primary"></div>
              </>
            )}
          </div>
        );

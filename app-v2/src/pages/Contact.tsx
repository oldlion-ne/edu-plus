              ...
              <div className="space-y-6">
                ...
                <div className="pt-6 border-t border-border flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="tel:+919856456703" className="text-sm font-semibold font-mono text-foreground hover:text-primary hover:underline">
                      {t('hotlinePhone')}
                    </a>
                  </div>
                </div>
                ...
                <div className="pt-6 border-t border-border flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href={`mailto:${t('inquiriesEmail')}`} className="text-sm font-semibold font-mono text-foreground hover:text-primary hover:underline">
                      {t('inquiriesEmail')}
                    </a>
                  </div>
                </div>

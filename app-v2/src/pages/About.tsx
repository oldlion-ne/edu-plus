      ...
      <div id="story" className="max-w-[1200px] mx-auto px-6 md:px-12 relative z-10 mt-24">
        ...
        <div className="relative border-l border-border/80 pl-8 md:pl-16 ml-4 md:ml-8 space-y-24">
          ...
          <div className={`relative transition-all duration-1000 delay-100 transform ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              <div className="lg:col-span-5 self-stretch flex flex-col justify-center">
                <div className="relative h-56 w-full overflow-hidden rounded-lg bg-card/10 border border-border/50 flex flex-col justify-end p-6">
                  {/* Visual Background */}
                  <div aria-hidden className="absolute inset-0 select-none pointer-events-none">
                    ...
                    <div className="absolute -inset-x-12 top-6 aspect-square rounded-full border border-border/25 animate-[pulse_4s_infinite]"></div>
                    <div className="absolute -inset-x-4 top-16 aspect-square rounded-full border border-dashed border-primary/25"></div>
                    <div className="absolute -inset-x-20 top-24 aspect-square rounded-full border border-border/10"></div>
                  </div>
                  {/* Focal Node */}
          ...
          <div className={`relative transition-all duration-1000 delay-200 transform ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <div className="absolute -left-[41px] md:-left-[73px] top-4 flex items-center justify-center">
              <span className="relative flex h-5 w-5">
                <span className="relative inline-flex rounded-full h-5 w-5 bg-muted border-4 border-background"></span>
              </span>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              <div className="lg:col-span-5 self-stretch flex flex-col justify-center">
                <div className="relative h-56 w-full p-5 rounded-lg bg-card/10 border border-border/50 flex flex-col justify-between overflow-hidden">
                  ...
                  <div className="absolute w-1.5 h-1.5 rounded-full bg-primary/70 animate-[ping_2s_infinite] top-[28%] left-[30%]"></div>
                  <div className="absolute w-1.5 h-1.5 rounded-full bg-primary/70 animate-[ping_2s_infinite] top-[72%] right-[30%]"></div>

                  <div className="relative flex justify-between items-center z-10">
                    <div className="bg-background/90 backdrop-blur-sm shadow-sm ring-1 ring-border rounded-full px-2.5 py-1 text-[9px] font-mono text-muted-foreground flex items-center gap-1.5 hover:ring-primary/40 transition-all select-none">
                  ...
                  <div className="relative flex justify-center z-10">
                    <div className="bg-card shadow-black/10 ring-1 ring-primary/30 relative flex h-9 items-center rounded-full px-4 shadow-sm select-none">
          ...
          <div className={`relative transition-all duration-1000 delay-300 transform ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              <div className="lg:col-span-5 self-stretch flex flex-col justify-center">
                <div className="relative h-56 w-full px-5 py-8 rounded-lg bg-card/10 border border-border/50 flex justify-between items-end overflow-hidden">
                  {/* Grid Lines */}
                      ...
                      <div key={i} className="flex flex-col items-center gap-1 h-full w-px bg-foreground/10 relative" style={{ height: '100%' }}>
                        {isHighlighted && (
                          <>
                            ...
                            <div className="absolute -top-3 w-1.5 h-1.5 rounded-full bg-primary"></div>
                          </>
                        )}
                      </div>
                    );
          ...
          <div className={`relative transition-all duration-1000 delay-500 transform ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              <div className="lg:col-span-5 self-stretch flex flex-col justify-center">
                <div className="relative h-56 w-full flex items-center justify-center rounded-lg bg-card/10 border border-border/50 overflow-hidden">
